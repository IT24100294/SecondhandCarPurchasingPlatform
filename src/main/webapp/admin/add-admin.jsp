...
<head>
  ...
  <title>CarCare - Add Administrator</title>
...
<div class="admin-container">
  ...
  <aside class="admin-sidebar">
    <nav>
      ...
      <c:if test="${sessionScope.isSuperAdmin}">
        ...
        <a href="${pageContext.request.contextPath}/admin/add-admin" class="admin-nav-link active">
  ...
  <main class="admin-content">
    ...
    <div class="page-title">
      <h1><i class="fas fa-user-plus"></i> Add Administrator</h1>
    </div>
